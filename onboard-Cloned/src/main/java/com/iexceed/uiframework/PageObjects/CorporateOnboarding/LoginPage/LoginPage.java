package com.iexceed.uiframework.PageObjects.CorporateOnboarding.LoginPage;
...
public class LoginPage extends TestBase {
    ...
    public void setWaitUtilityUsername(){
        waitUtility.waitTillElementVisible(driver,userName,50 );
    }
    public void setWaitUtilityPassword(){
        waitUtility.waitTillElementVisible(driver,password,10);
    }
