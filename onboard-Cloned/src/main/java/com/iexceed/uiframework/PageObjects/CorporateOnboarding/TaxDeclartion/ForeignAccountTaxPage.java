...
public class ForeignAccountTaxPage extends TestBase {
...
//value added taxx
    ...
    @FindBy(xpath="//span[@id='select2-appdtl__TaxDetails__i__taxFatca__exmApplCatgCode-container']")
    ...
    public CommonReportingStandardsPage corpuserContinue() throws Exception {
        waitUtility.waitForSeconds(10);
        commonElements.click(CrpContinueBtn);
        return new CommonReportingStandardsPage();
    }
    ...
    public void FACTDetails(String UsPersonDD) throws Exception {
        waitUtility.waitTillElementVisible(driver,UsPersoYES,45);
        commonElements.click(UsPersoYES);
        commonElements.click(UsPersonYEsCatDD);
        selectionOfDropdown(UsPersonDD,UsPersonYesCatList);
        commonElements.click(benOwnerYes);
        corpuserContinue();
