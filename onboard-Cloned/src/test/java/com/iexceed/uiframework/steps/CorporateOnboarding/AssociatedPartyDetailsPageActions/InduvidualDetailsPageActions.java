...
public class InduvidualDetailsPageActions extends TestBase {

    private static Logger LOGGER = LogManager.getLogger(InduvidualDetailsPageActions.class);
    ...
    public  InduvidualDetailsPageActions(){
