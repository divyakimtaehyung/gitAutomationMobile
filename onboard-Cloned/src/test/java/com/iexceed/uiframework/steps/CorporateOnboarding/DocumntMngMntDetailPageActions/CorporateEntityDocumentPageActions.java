...
public class CorporateEntityDocumentPageActions extends TestBase {

    private static Logger LOGGER = LogManager.getLogger(CorporateEntityDocumentPageActions.class);
    CorporateEntityDocumentPage corporateEntityDocumentPage=new CorporateEntityDocumentPage();

    public  CorporateEntityDocumentPageActions(){
